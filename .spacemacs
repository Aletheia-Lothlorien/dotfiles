...
values."
  (setq-default
   ...
   '(
     ...
     better-defaults
     (agda :variables agda-mode-path "/usr/share/emacs/site-lisp/agda/agda2.el")
     asm
     (c-c++ :variables
...
`dotspacemacs/user-config' first."
  ...
  ;; This is to resolve the ISP's redirecting nonexistent addresses to own servers.
...
you should place your code here."
  ...
  (setq racer-rust-src-path "/home/akhi/Downloads/rustc-1.11.0/src")
  (spacemacs/set-leader-keys-for-major-mode 'haskell-mode
    "mht" 'ghc-show-type)
  (setq org-ditaa-jar-path "/usr/share/ditaa/ditaa.jar")
  (setq ranger-cleanup-on-disable t)
  (setq-default flycheck-scalastylerc "/home/akhi/Downloads/scalastyle_config.xml")
  (setq x86-lookup-pdf "/home/akhi/Documents/Code/Systems/Intel Achitecture Set/325383-sdm-vol-2abcd.pdf")
  (require 'agda-input)
...
;;     (let (
;;           (-fontList '("Source Code Pro-10" "Fira Code-10"))
;;           -fontToUse
;;           -stateBefore
;;           -stateAfter)
 ...
 '(safe-local-variable-values
   (quote
    ((eval setq buffer-face-mode-face
     ...
     (flycheck-set-checker-executable . c/c++-gcc)))))
(custom-set-faces
